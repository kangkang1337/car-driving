    ...
    while(1)
    {
        for(j = 1; j <= led_num; j++)
        {
            ...
            for(i = 1; i <= led_num; i++)
            {
                ...
                {
                    L_ws2812_rgb(i, 30, 30, 30);
                    R_ws2812_rgb(i, 30, 30, 30);
                }
                else
                {
                    L_ws2812_rgb(i, WS_DARK);
...
void LR_rainbow(void)
{
    L_ws2812_rgb(1, WS_RED);
    L_ws2812_rgb(2, WS_YELLOW);
    L_ws2812_rgb(3, WS_GREEN);
    L_ws2812_rgb(4, WS_CYAN);
    L_ws2812_rgb(5, WS_BLUE);
    L_ws2812_rgb(6, WS_PURPLE);

    R_ws2812_rgb(1, WS_RED);
    R_ws2812_rgb(2, WS_YELLOW);
    R_ws2812_rgb(3, WS_GREEN);
    R_ws2812_rgb(4, WS_CYAN);
    R_ws2812_rgb(5, WS_BLUE);
    R_ws2812_rgb(6, WS_PURPLE);
