...
void LR_rainbow(void)
{
    ...
    while(1)
    {
        for(j = 0; j < led_num; j++)
        {
            for(i = 1; i <= led_num; i++)
            {
                color_index = (i + j - 1) % led_num;
                L_ws2812_rgb(i, color[color_index][0], color[color_index][1], color[color_index][2]);
                R_ws2812_rgb(i, color[color_index][0], color[color_index][1], color[color_index][2]);
            }
